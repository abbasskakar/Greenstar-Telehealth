...
export default async function ProviderAppointmentChat({
  params,
}: {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3">
      <div className="flex shrink-0 items-center justify-between">
        ...
        <Link href={`/provider/appointments/${id}`} className="inline-flex items-center gap-1.5 text-sm font-semibold text-primary hover:underline">
