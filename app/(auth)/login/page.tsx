...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (isPublic) {
      ...
      // CNIC maps to a deterministic identity behind the scenes.
      ...
      email = username.includes("@") ? username.trim() : `${username.trim()}`;
    }
    if (!password) {
    ...
    try {
      ...
      if (error) {
        setError(
          "We couldn't sign you in. Accounts are being set up — check your credentials and try again.",
        );
      } else {
